...
(function(global, factory) {
    ...
    var prefixLinearGradient = function(context, tokens) {
        ...
        parseFunctionArgs(tokens).forEach(function(arg, i) {
            if (i === 0) {
                var firstToken = arg[0];
                if (
                    firstToken.type === 20 /* IDENT_TOKEN */ && ['top', 'left', 'right', 'bottom'].indexOf(firstToken.value) !== -1
                ) {
                    angle$1 = parseNamedSide(arg);
                    return;
                } else if (isAngle(firstToken)) {
    ...
    var breakWords = function(str, styles) {
        var breaker = LineBreaker(str, {
            ...
            wordBreak: styles.overflowWrap === 'break-word' /* BREAK_WORD */ ?
                'break-word' :
                styles.wordBreak,
        });
        var words = [];
    ...
    var parseNodeTree = function(context, node, parent, root) {
        for (
            var childNode = node.firstChild, nextNode = void 0; childNode; childNode = nextNode
        ) {
    ...
    var ElementPaint = /** @class */ (function() {
        ...
        ElementPaint.prototype.getEffects = function(target) {
            var inFlow = [2 /* ABSOLUTE */ , 3 /* FIXED */ ].indexOf(
            ...
            while (parent) {
                ...
                if (
                    ...
                    inFlow = [2 /* ABSOLUTE */ , 3 /* FIXED */ ].indexOf(
    ...
    var paddingBox = function(element) {
        ...
        return bounds.add(
            ...
            styles.borderTopWidth, -(styles.borderRightWidth + styles.borderLeftWidth), -(styles.borderTopWidth + styles.borderBottomWidth)
        );
    };
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            this.ctx.drawImage(
                                img, -this.options.x * this.options.scale, -this.options.y * this.options.scale
                            );
                            return [2 /*return*/ , this.canvas];
                    }
                });
